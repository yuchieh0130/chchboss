...
def insertLocation():
    ...
    cur = conn.cursor()
    sql = "INSERT INTO location (longitude, latitude, start_time, duration, speed, speed, name1, name2, name3, name4, name5, category1, category2, category3, category4, category5, user_id) VALUES ( %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
    adr = (longitude, latitude, start_time, duration, speed, speed, name1, name2, name3, name4, name5, category1, category2, category3, category4, category5, user_id)
    cur.execute(sql, adr)
    conn.commit()
    cur.close()
    return jsonify({"status_code": 200})
